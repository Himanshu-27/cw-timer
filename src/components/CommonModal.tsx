      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold">
              {type === "add" ? "Add New Timer" : "Edit Timer"}
            </h2>
          </div>
          <CloseButtonModal handleClose={handleClose} />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                return (
                  <div key={label}>
                    ...
                    <input
                      ...
                      max={maxValues[index]}
                      value={values[index]}
                      onChange={(e) => setters[index](Math.min(maxValues[index], parseInt(e.target.value) || 0))}
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            <CancelButtonModal handleClose={handleClose} />
            <SubmitModalButton text={type === "add" ? "Add Timer" : "Save Changes"} isTimeValid={isTimeValid} isTitleValid={isTitleValid} />
          </div>
        </form>
      </div>
    </div>
